...
export default function Sidebar(_ref) {
  ...
  { index: 6, condition: !!selectedGroup, dom: React.createElement(PanelGroupEditor, { state: state, groupID: selectedGroup ? selectedGroup[0] : null }) }, { index: 7, condition: true, dom: React.createElement(PanelFloorplan, { state: state }) }];
