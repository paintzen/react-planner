...
var _panelFloorplan = require('./panel-floorplan');

var _panelFloorplan2 = _interopRequireDefault(_panelFloorplan);
...
function Sidebar(_ref) {
  ...
  { index: 6, condition: !!selectedGroup, dom: _react2.default.createElement(_panelGroupEditor2.default, { state: state, groupID: selectedGroup ? selectedGroup[0] : null }) }, { index: 7, condition: true, dom: _react2.default.createElement(_panelFloorplan2.default, { state: state }) }];
